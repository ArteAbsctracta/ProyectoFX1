...
import proyectofx.utils.VentanaAlert;
...
@FXML
    ...
    Boolean isnew=false;
    @FXML
    private TextField txt_curpEditar;
    ...
    private void editarUsuario(ActionEvent event) {
        ...
        if (this.usuario != null) {
            ...
            if (this.txt_nombreEditar.getText().isEmpty()
                    ...
                    || this.txt_curpEditar.getText().isEmpty()
                    || position <= -1) {
                ...
                params.put("curp", this.txt_curpEditar.getText());
                    ...
                    if (response == ButtonType.OK) {
                        try {
                            if (this.usuario.getIdRol() != 1) {
                                String respuesta = Requests.post("/Usuarios/actualizarUsuario/"+this.usuario.getIdUsuario(), params);
    ...
    public void cargarUsuario() {
        ...
        if (this.usuario.getIdRol() != 1) {
            ...
            this.txt_curpEditar.setText(usuario.getCurp());
        } else {
            this.txt_nombreEditar.setText(usuario.getNombre());
            this.txt_apellidoPaternoEditar.setText(usuario.getApellidoPaterno());
            this.txt_apellidoMaternoEditar.setText(usuario.getApellidoMaterno());
